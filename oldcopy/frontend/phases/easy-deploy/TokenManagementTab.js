...
const TokenManagementTab = ({
  ...
  <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
    ...
    <div style={{ marginBottom: '2rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: '1rem', flexWrap: 'wrap' }}>
        <div style={{ flex: 1, minWidth: '300px' }}>
          <label style={{ color: '#1a237e', fontWeight: 'bold', display: 'block', marginBottom: '0.5rem' }}>Select Factory for Token Deployment:</label>
          <select
      ...
      {selectedFactory && (
        <div style={{ 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
            ...
            <span style={{ color: '#28a745', fontWeight: 'bold' }}>✓ Ready for Token Deployment</span>
          </div>
    ...
    {/* Deployed Tokens Section - Moved to top */}
    {deploymentDetails && deploymentDetails.tokens && deploymentDetails.tokens.length > 0 && (
      <div style={{ margin: "2rem 0" }}>
        <h4 style={{ color: '#1a237e', marginBottom: "1rem" }}>Deployed Tokens</h4>
        <div style={{ 
          padding: "1.5rem", 
    ...
    {/* Step 1: Claim Issuer */}
    <div style={{ margin: "2rem 0" }}>
      <h4 style={{ color: '#1a237e', marginBottom: "1rem" }}>Step 1: Claim Issuer</h4>
      <div style={{ 
        padding: "1.5rem", 
        backgroundColor: "#f8f9fa", 
        borderRadius: "8px",
    ...
    {/* Step 2: Claim Topics */}
    <div style={{ margin: "2rem 0" }}>
      <h4 style={{ color: '#1a237e', marginBottom: "1rem" }}>Step 2: Claim Topics</h4>
    ...
    {/* Step 3: Deploy Token */}
    <div style={{ margin: "2rem 0" }}>
      <h4 style={{ color: '#1a237e', marginBottom: "1rem" }}>Step 3: Deploy Token</h4>
